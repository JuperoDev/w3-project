<template>
  <div class="armyComposer_container">
    ...
    <!-- Include the ArmyBuilderCharacter component -->
    <ArmyBuilderCharacter
      :url="url"
      :armyIndex="armyIndex"
...
const totalPoints = computed(() => {
  return totalBattlelinePoints.value + totalOtherPoints.value;
});
...
const handleAddCharacter = (character) => {
  // Add any logic needed when a character is added
};
...
<style scoped>
.saved-battlelines, .saved-others {
  margin-top: 20px;
}

.saved-battlelines h3, .saved-others h3 {
  margin-bottom: 10px;
}

.saved-battlelines div, .saved-others div {
  margin-bottom: 5px;
}
