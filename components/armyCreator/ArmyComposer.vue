...
<!-- 
    {{ selectedArmy }} 
      {{ selectedFaction }}  -->
    <AlliedUnits
    v-if="selectedArmy !== 'tyranids' && selectedArmy !== 'aeldari' && selectedArmy !== 'drukhari' && selectedArmy !== 'genestealers cults' && selectedArmy !== 'orks' && selectedArmy !== 'tau empire' && selectedArmy !== 'leagues of votann' && selectedArmy !== 'necrons'  && selectedArmy !== 'chaos knights' && selectedArmy !== 'chaos daemons'"
      :url="sanitizedUrl"
      :armyIndex="armyIndex"
      :selectedDetachment="selectedDetachment"
      class="mt-4 mb-24"
